<?php /*a:2:{s:72:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\setting\clear.html";i:1556442403;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<div class="widget-head">
				<div class="widget-title">清理缓存</div>
			</div>
							...
							<div class="layui-col-sm10">
								 <?php foreach($cacheList as $key => $item): ?>
									<div class="layui-input-block layui-col-sm1">
									  <input type="checkbox" name="cache[keys][]"  value="<?php echo htmlentities($key); ?>" lay-skin="primary" title="<?php echo htmlentities($item['name']); ?>" checked="">
									</div>
								<?php endforeach; ?>
							</div>
						</div>
