<?php /*a:2:{s:74:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\item\spec\index.html";i:1557484282;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="box-body">
						...
						<?php if(!$list->isEmpty()): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								...
								<?php echo htmlentities($vo['spec_item']); ?>
									...
									<td class="layer-text-middle">
										<?php echo htmlentities($vo['sort_order']); ?>
									</td>
									<td class="layer-text-middle">
