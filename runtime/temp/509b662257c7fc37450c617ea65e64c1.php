<?php /*a:2:{s:74:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\item\type\index.html";i:1556090954;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
			<div class="widget-head">
				<div class="widget-title">商品类型列表</div>
			</div>
			<div class="layui-col-md12 layui-col-xs12 widget-body">
					...
					<div class="layui-form-item">
						<div class="layui-btn-item layui-btn-item-xs">
							<div class="layui-col-md3">
								<a class="layui-btn"
								   href="<?php echo url('item/saveType'); ?>">
									<i class="layui-icon"></i> 新增商品类型
								</a>
							</div>
						</div>
					</div>
							  ...
							  <tr>
								...
								<td class="layer-text-middle">
									<div class="tpl-table-black-operation">
										<a href="<?php echo url('item/saveType',
											['id' => $vo['id']]); ?>">
				...
				<div class="layui-col-md12 layui-col-xs12">
						<div class="layui-fr"><?php echo $page; ?> </div>
...
<script>
    $(function () {
        ...
        $('.item-delete').delete('id', url,'','Type');
