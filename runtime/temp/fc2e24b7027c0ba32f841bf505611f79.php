<?php /*a:2:{s:68:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\tpl\store.html";i:1557313096;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			...
			<form id="my-form" class="layui-form"  enctype="multipart/form-data" method="post">
				    ...
				    <div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<input type="text" class="layui-input" name="tabbar[app_title]"
									   value="<?php echo isset($model1['app_title']) ? htmlentities($model1['app_title']) : ''; ?>">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<label class="layui-inline">
									<input type="radio" name="tabbar[top_text_color]" value="10" data-am-ucheck
										<?php echo $model1['top_text_color']['value']===10 ? 'checked'  :  ''; ?>> 黑色
								</label>
								<label class="layui-inline">
									<input type="radio" name="tabbar[top_text_color]" value="20" data-am-ucheck
										<?php echo $model1['top_text_color']['value']===20 ? 'checked'  :  ''; ?>> 白色
								</label>
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left layer-padding-top-xs">
								<input type="color" class="layui-input" name="tabbar[top_background_color]"
									   value="<?php echo isset($model1['top_background_color']) ? htmlentities($model1['top_background_color']) : ''; ?>" required>
							</div>
						</div>
				...
				<div class="layui-box">
					<div class="layui-col-sm2 laui-col-width selectStyleBox">				
						<!-- <div class="layui-form-item ">
							...
							<div class="layui-col-sm7">
								<div class="layui-col-sm6">
									<input type="color" style="width:28px;height:28px;" class="layui-input" name="tabbar[color1]" value="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : ''; ?>" data-color1="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : ''; ?>" required>
								</div>
								<div class="layui-col-sm6">
									<input type="color" style="width:28px;height:28px;" class="layui-input" name="tabbar[color1]"  value="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : ''; ?>" data-color2="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : ''; ?>" required>
								</div>
							</div>
						</div>	 -->
						<div class="layui-form-item color">
							...
							<div class="layui-col-sm5 ">
								<input type="color" class="layui-sexi color_diy" style="color:<?php echo isset($model['color1']) ? htmlentities($model['color1']) : '#ff495e'; ?>"  data-color1="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : '#ff495e'; ?>" >
								<input type="color" class="layui-sexi color_diy" style="color:<?php echo isset($model['color1']) ? htmlentities($model['color1']) : '#555'; ?>"  data-color2="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : '#555'; ?>" >
							</div>
						</div>							
						<div class="layui-form-item color">
					...
					<input type="hidden" name="tabbar[app_id]" value="<?php echo isset($model['app_id']) ? htmlentities($model['app_id']) : ''; ?>">
...
<script>
    $(function () {
         ...
         */
        $('#my-form').superForm();
		var color1="<?php echo isset($model['color1']) ? htmlentities($model['color1']) : '#ff495e'; ?>";
		var color2="<?php echo isset($model['color2']) ? htmlentities($model['color2']) : '#555'; ?>";
