<?php /*a:2:{s:81:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\setting\delivery\index.html";i:1556090954;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<div class="widget-head">
				<div class="widget-title">运费模板</div>
			</div>
			<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
				<div class="layui-col-sm12 layui-col-md6 layui-col-lg6">
					<div class="layui-form-item">
							<div class="">
								<a class="layui-btn"
								   href="<?php echo url('setting/edit'); ?>">
				...
				<div class="layui-col-md12" >
					<table width="100%" class="layui-table">
						...
						<tbody>
						<?php if((!$list->isEmpty())): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
								<tr>
									<td class="layer-text-middle"><?php echo htmlentities($item['delivery_id']); ?></td>
									...
									<?php echo htmlentities(date("Y-m-d H:i",!is_numeric($item['create_time'])? strtotime($item['create_time']) : $item['create_time'])); ?></td>
									<td class="layer-text-middle">
										<div class="tpl-table-black-operation">
											<a href="<?php echo url('setting/edit',
												['delivery_id' => $item['delivery_id']]); ?>">
												<i class="mdi menu-icon mdi-pencil"></i> 编辑
											</a>
											<a href="javascript:;" class="item-delete tpl-table-black-operation-del"
											   data-id="<?php echo htmlentities($item['delivery_id']); ?>">
...
<script>
    $(function () {
        ...
        $('.item-delete').delete('id', url,'','Delivery');
