<?php /*a:2:{s:70:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\app\setting.html";i:1557454083;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
			...
			<form id="my-form" class="layui-form " enctype="multipart/form-data" method="post">
				...
				<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<input type="text" class="layui-input" onBlur="removeSpacing(this)" name="app[appkey]"
						...
						<div class="layui-form-item">
							...
							<div class="layui-col-sm6 layer-midd-left">
								<input type="text" class="layui-input" onBlur="removeSpacing(this)" name="app[app_secret]"
				...
				<div class="layui-col-md12 layui-col-xs12 widget-body">
					<div class="layui-form-item">
						...
						<div class="layui-col-sm6 layer-midd-left">
							<input type="text" class="layui-input" onBlur="removeSpacing(this)" name="app[mchid]"
								   value="<?php echo isset($app['mchid']) ? htmlentities($app['mchid']) : ''; ?>">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label form-require ron-wide">
						...
						<div class="layui-col-sm6 layer-midd-left">
							<input type="text" class="layui-input" onBlur="removeSpacing(this)" name="app[apikey]"
								   value="<?php echo isset($app['apikey']) ? htmlentities($app['apikey']) : ''; ?>">
						</div>
					</div>
