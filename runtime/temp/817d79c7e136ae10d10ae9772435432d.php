<?php /*a:2:{s:80:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\market\coupon\receive.html";i:1556090954;s:65:"E:\phpstudy\PHPTutorial\WWW\666\application\user\view\layout.html";i:1557454083;}*/ ?>
<!DOCTYPE html>
<html lang="en">
						...
						<?php if((!$list->isEmpty())): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
								<tr>
									<td class="layer-text-center">
										...
										<p class="layer-link-muted">(用户id：<?php echo htmlentities($item['user_id']); ?>)</p>
									</td>
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?php echo url('marketcoupon/delete'); ?>";
